    ...
    resultCard.innerHTML = `
        ...
        <div class="result-text-body">
            ...
            <div class="result-section-box">
                ...
                <p class="result-paragraph">あなたが引き寄せるのは、<br>
                「導きを求める人」と<br>
                「あなたを守ろうとする人」です。</p>
                <div class="result-definition">
            ...
            <div class="result-section-box">
                ...
                <p class="result-paragraph">
                    ...
                    自分の内側、理性と感情、強さと弱さ、<br>
                    光と影、そのすべてを統合し、<br>
                    ひとつの完全な存在になること。
                </p>
                <p class="result-paragraph">「3」という数字が示すように、<br>
                あなたの人生には3つの段階があります。</p>
                <ul class="result-list">
                    <li>第一段階（新月）<br>
                    自分を知る時期。<br>まだ光は弱く、手探りの時期です。</li>
                    <li>第二段階（半月）<br>
                    他者を照らす時期。<br>自分の光を外へ向け、<br>
                    人を導き始めます。</li>
                    <li>第三段階（満月）<br>
                    完全なる調和。<br>内と外、自己と他者、<br>
                    すべてが統合された状態です。</li>
                </ul>
                <p class="result-paragraph">今、あなたがどの段階にいるかは、<br>
                あなた自身が一番よく知っています。<br>
                焦る必要はありません。<br>
                満月は必ず訪れます。</p>
            </div>
